...
import { BUILD_STEP_IF_CONDITION_EXPRESSION_REGEXP, BUILD_STEP_OR_BUILD_GLOBAL_CONTEXT_REFERENCE_REGEX, } from './utils/template.js';
...
const BuildFunctionCallSchema = Joi.object({
    ...
    if: Joi.string().pattern(BUILD_STEP_IF_CONDITION_EXPRESSION_REGEXP, 'allowed "if" condition values regex'),
